  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-lg shadow-md p-12 text-center">
        ...
        <h3 className="text-2xl font-semibold mb-2">Lab Tests Management</h3>
        <p className="text-gray-600 mb-6">Order and track laboratory tests for patients</p>
        <button className="bg-primary-600 hover:bg-primary-700 text-white px-6 py-3 rounded-lg">
          Create First Lab Test Order
        </button>
      </div>
    </div>
  );
